...
<div class="flex mb-4 space-x-4">
	<button onclick={props.sidebarT}>
		<div
			class="flex justify-between items-center py-4 px-4 rounded-xl border shadow-md duration-200 ease-in-out border-[#202020] bg-[#09090B] text-[#D3D3D3] hover:bg-[#202020]"
		>
